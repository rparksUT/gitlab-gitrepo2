...
def main():
    ...
    print('"{0:s}" contains the following letter counts (feature branch B):'.format(phrase))
    print('"{0:s}" contains the following letter counts (feature branch A):'.format(phrase))
